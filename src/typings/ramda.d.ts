...
declare namespace RamdaDefs {
    ...
    interface Static {
        ...
        */
         ...
         */
        filter<T>(fn: (value: T) => boolean): <T>(list: Iterable<T>) => T[];
        filter<T>(fn: (value: T) => boolean, list: Iterable<T>): T[];

        /**
         * Returns the first element of the list which matches the predicate, or `undefined` if no
         * element matches.
         */
        find<T>(fn: (a: T) => boolean, list: Iterable<T>): T;
        find<T>(fn: (a: T) => boolean): <T>(list: Iterable<T>) => T;
         ...
         */
        forEach<T>(fn: (x: T) => void, list: Iterable<T>): Iterable<T>;
        forEach<T>(fn: (x: T) => void): (list: Iterable<T>) => Iterable<T>;
        ...
        */
        ...
        reduceWhile<T, TResult>(pred: (acc: TResult, elem: T) => boolean, fn: (acc: TResult, elem: T) => TResult|Reduced): (acc: TResult, list: T[]) => TResult;
        reduceWhile<T, TResult>(pred: (acc: TResult, elem: T) => boolean, fn: (acc: TResult, elem: T) => TResult|Reduced, acc: TResult): (list: T[]) => TResult;
        // reduce<T, TResult>(fn: RPlaceholder, acc: TResult, list: T[]): (fn: (acc: TResult, elem: T) => TResult|Reduced) => TResult;
        ...
        */
        ...
        zipObj<T>(keys: string[]): (values: Array<any>) => T;
